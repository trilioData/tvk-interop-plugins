...
ocpetcdbackuprestoreSha256File="ocp-etcd-backup-restore-sha256.txt"
...
sed -i "s/OCP_ETCD_BACKUP_RESTORE_TAR_CHECKSUM/$ocp_etcd_backup_restore_sha/g" "$ocp_etcd_backup_restore_template_manifest"
